...
O meu objetivo atual é construir uma base sólida em design de interface e front-end, dominar a lógica de programação com Java (Back-End) e desenvolver minha fluência no inglês técnico.
